...
class RemoveTrailingColumnStructure {
     ...
     * This converter removes invalid columns from the end of the table. Invalid columns are defined as the columns of the table which only contain a maximum of threshold invalid values. The invalid values are empty cells by default but can be extended using the blockList properties.  The converterType MUST be REMOVE_TRAILING_COLUMN. 
