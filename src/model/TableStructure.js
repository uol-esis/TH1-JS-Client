...
class TableStructure {
     ...
     */
    constructor(name, delimiter, structures) { 
        
        TableStructure.initialize(this, name, delimiter, structures);
    }
     ...
     */
    static initialize(obj, name, delimiter, structures) { 
        obj['name'] = name;
...
TableStructure.RequiredProperties = ["name", "delimiter", "structures"];
