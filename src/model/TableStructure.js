...
class TableStructure {
     ...
     */
    constructor(name, delimiter, structures, endRow, endColumn) { 
        
        TableStructure.initialize(this, name, delimiter, structures, endRow, endColumn);
    }
     ...
     */
    static initialize(obj, name, delimiter, structures, endRow, endColumn) { 
        obj['name'] = name;
...
TableStructure.RequiredProperties = ["name", "delimiter", "structures", "endRow", "endColumn"];
 ...
 */
TableStructure.prototype['delimiter'] = undefined;
