...
class Structure {
    ...
    constructor(instance = null) {
        ...
        if (discriminatorInstance) {
            ...
            throw new Error("No match found constructing `Structure` with oneOf schemas AddHeaderNameStructure, FillEmptyRowStructure, RemoveColumnByIndexStructure, RemoveFooterStructure, RemoveGroupedHeaderStructure, RemoveHeaderStructure, RemoveInvalidRowsStructure, RemoveRowByIndexStructure, RemoveTrailingColumnStructure, ReplaceEntriesStructure, SplitRowStructure. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
...
Structure.OneOf = ["AddHeaderNameStructure", "FillEmptyRowStructure", "RemoveColumnByIndexStructure", "RemoveFooterStructure", "RemoveGroupedHeaderStructure", "RemoveHeaderStructure", "RemoveInvalidRowsStructure", "RemoveRowByIndexStructure", "RemoveTrailingColumnStructure", "ReplaceEntriesStructure", "SplitRowStructure"];
