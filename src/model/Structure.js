...
class Structure {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `Structure` with oneOf schemas AddHeaderNameStructure, FillEmptyRowStructure, RemoveColumnByIndexStructure, RemoveFooterStructure, RemoveGroupedHeaderStructure, RemoveHeaderStructure, RemoveRowByIndexStructure, ReplaceEntriesStructure. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `Structure` with oneOf schemas AddHeaderNameStructure, FillEmptyRowStructure, RemoveColumnByIndexStructure, RemoveFooterStructure, RemoveGroupedHeaderStructure, RemoveHeaderStructure, RemoveRowByIndexStructure, ReplaceEntriesStructure. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @param {(module:model/AddHeaderNameStructure|module:model/FillEmptyRowStructure|module:model/RemoveColumnByIndexStructure|module:model/RemoveFooterStructure|module:model/RemoveGroupedHeaderStructure|module:model/RemoveHeaderStructure|module:model/RemoveRowByIndexStructure|module:model/ReplaceEntriesStructure)} obj The actual instance.
     */
...
Structure.OneOf = ["AddHeaderNameStructure", "FillEmptyRowStructure", "RemoveColumnByIndexStructure", "RemoveFooterStructure", "RemoveGroupedHeaderStructure", "RemoveHeaderStructure", "RemoveRowByIndexStructure", "ReplaceEntriesStructure"];
