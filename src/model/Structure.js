...
class Structure {
    ...
    constructor(instance = null) {
        ...
        if (discriminatorInstance) {
            ...
            throw new Error("Multiple matches found constructing `Structure` with oneOf schemas AddHeaderNameStructure, FillEmptyRowStructure, MergeColumnsStructure, RemoveColumnByIndexStructure, RemoveFooterStructure, RemoveGroupedHeaderStructure, RemoveHeaderStructure, RemoveInvalidRowsStructure, RemoveRowByIndexStructure, RemoveTrailingColumnStructure, ReplaceEntriesStructure, SplitRowStructure. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `Structure` with oneOf schemas AddHeaderNameStructure, FillEmptyRowStructure, MergeColumnsStructure, RemoveColumnByIndexStructure, RemoveFooterStructure, RemoveGroupedHeaderStructure, RemoveHeaderStructure, RemoveInvalidRowsStructure, RemoveRowByIndexStructure, RemoveTrailingColumnStructure, ReplaceEntriesStructure, SplitRowStructure. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {(module:model/AddHeaderNameStructure|module:model/FillEmptyRowStructure|module:model/MergeColumnsStructure|module:model/RemoveColumnByIndexStructure|module:model/RemoveFooterStructure|module:model/RemoveGroupedHeaderStructure|module:model/RemoveHeaderStructure|module:model/RemoveInvalidRowsStructure|module:model/RemoveRowByIndexStructure|module:model/RemoveTrailingColumnStructure|module:model/ReplaceEntriesStructure|module:model/SplitRowStructure)} The actual instance.
     */
    getActualInstance() {
...
Structure.OneOf = ["AddHeaderNameStructure", "FillEmptyRowStructure", "MergeColumnsStructure", "RemoveColumnByIndexStructure", "RemoveFooterStructure", "RemoveGroupedHeaderStructure", "RemoveHeaderStructure", "RemoveInvalidRowsStructure", "RemoveRowByIndexStructure", "RemoveTrailingColumnStructure", "ReplaceEntriesStructure", "SplitRowStructure"];
